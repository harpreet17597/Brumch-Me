                  ...
                  <tbody>
                    @if($users && $users->count())
                      @foreach($users as $user)
                        <tr>
                            <td>{{$user->name}}@if($user->is_suspended == '1')
                            ...
                            <td>
                              <div class="form-group">
                                  ...
                                  <input type="checkbox" class="custom-control-input change-user-active-status" id="active-{{$user->id}}" data-user-id="{{$user->id}}" name="active" @if($user->is_suspended =='1'){{'checked'}}@endif> 
